...
#define MAX_NO_OF_IPSES 5
#define MAX_NO_OF_NODES 2 //total no of nodes with IP addresses
#define MAX_NO_OF_TAGS 10   //total no of distinct tags
...
//bohatei ips-related types and values
typedef enum {Diff_0, Diff_1, Diff_2, Diff_3, Diff_4, Diff_5} srcSynAckCount;//keeps count of observed SYNs/ACKs per source
#define  DIFF_THRESHOLD 3
#define  MAX_NO_OF_BOHATEI 10
srcSynAckCount ipsDiffConnStates[MAX_NO_OF_IPSES][MAX_NO_OF_BOHATEI];

...
# First NAT
./flowtag_control mb add -mbId 1 -hostId 10 -type CONSUME -address 20.0.0.1 -mask 255.255.255.0

# FW
./flowtag_control mb add -mbId 4 -hostId 11 -type CONSUME

# Host
./flowtag_control mb add -mbId 100 -hostId 1 -type CONSUME -address 10.0.0.1 -mask 255.0.0.0
./flowtag_control mb add -mbId 101 -hostId 2 -type CONSUME -address 11.0.0.1 -mask 255.0.0.0
